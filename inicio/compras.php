...
$sel_compras = $con->prepare("SELECT * FROM compras WHERE correo_usuario = ? AND status_compra = 'COMPRADO' ORDER BY fecha DESC ");
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-8">
					...
					<h5>Pedido: <?php echo $f_compras['status_envio'] ?></h5>
